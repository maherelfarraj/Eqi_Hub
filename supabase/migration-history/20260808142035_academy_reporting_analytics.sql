...
create function public.get_academy_report(
...
begin
  ...
  select jsonb_build_object(
    ...
    'welfare', jsonb_build_object(
      ...
      'horses_active', (select count(*) from public.horses where academy_id=target_academy_id and status='active')
    ),
    'daily', (
...
create function public.record_academy_report_export(
  target_academy_id uuid,
  target_starts_on date,
  target_ends_on date,
  target_currency text
