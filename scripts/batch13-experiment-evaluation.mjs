...
export function validateBatch13Config(config) {
  ...
  if (!object(thresholds) || !finite(thresholds.minimum_pck) || thresholds.minimum_pck < 0.5 || thresholds.minimum_pck > 1 || !finite(thresholds.maximum_mean_error) || thresholds.maximum_mean_error <= 0 || thresholds.maximum_mean_error > 0.25 || !finite(thresholds.maximum_validation_test_gap) || thresholds.maximum_validation_test_gap < 0 || thresholds.maximum_validation_test_gap > 0.2 || !Number.isInteger(thresholds.minimum_samples_per_split) || thresholds.minimum_samples_per_split < 1) errors.push("thresholds are invalid or outside safe bounds");
